...
@pytest.mark.torch
def test_train_cnn_stage_streaming_runs_and_produces_val_metrics(tmp_path):
    from anemoi.models.cnn import build_cnn
    from anemoi.training.curriculum import stage_a
    ...
    trained_model, train_loss, val_loss, val_metrics, stats = train_cnn_stage_streaming(
...
@pytest.mark.torch
def test_train_cnn_stage_streaming_raises_on_empty_cache(tmp_path):
    from anemoi.models.cnn import build_cnn
    from anemoi.training.curriculum import stage_a
    from anemoi.training.real_run_cnn import train_cnn_stage_streaming
...
@pytest.mark.torch
def test_run_cnn_curriculum_streaming_completes_both_stages(tmp_path):
    from anemoi.tracking.checkpoint_store import CheckpointStore, S3Config
    from anemoi.training.real_run_cnn import run_cnn_curriculum
