...
<Dialog.Root bind:open>
  ...
  <Dialog.Portal>
    ...
    >
      ...
      <div
        class="flex items-center justify-between gap-2.5 border-b border-border px-4 py-4"
      >
        <a
          href="/"
          onclick={() => (open = false)}
      ...
      <div
        class="border-t border-border p-3 text-[10px] text-text-faint space-between items-stretch"
      >
        <p>{version ? `v${version} · ` : ""}</p>

        <div class="justify-end items-center gap-1">
